...
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    ...
    <div class="w-100">
        ...
        <div class="form-group">
            ...
            <asp:CompareValidator ID="cvGia" runat="server" ControlToValidate="txtDonGia"
                ...
                ErrorMessage="Đơn giá phải là số lớn hơn 0" ForeColor="Red" Display="Dynamic">*</asp:CompareValidator>
        </div>
        ...
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ID="rfvHinh" runat="server" ControlToValidate="FHinh"
                ErrorMessage="Ảnh bìa không được bỏ trống" ForeColor="Red" Display="Dynamic">*</asp:RequiredFieldValidator>
        </div>
    ...
    <br />
    <asp:ValidationSummary ID="vsTongHop" runat="server" ForeColor="Red" HeaderText="Vui lòng khắc phục các lỗi sau:" />
