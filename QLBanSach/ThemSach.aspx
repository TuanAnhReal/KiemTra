...
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
   <h2 class="text-center mt-3">THÊM SÁCH MỚI</h2>
    <hr />
    
    <asp:ValidationSummary ID="vsTongHop" runat="server" ForeColor="Red" HeaderText="Vui lòng kiểm tra lại các lỗi sau:" CssClass="alert alert-danger" />
    ...
    <div class="w-100">
        ...
        <div class="form-group">
            ...
            <asp:CompareValidator ID="cvGia" runat="server" ControlToValidate="txtDonGia" 
                ...
                ErrorMessage="Đơn giá phải là số dương (>0)" ForeColor="Red" Display="Dynamic">*</asp:CompareValidator>
        </div>
        ...
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ID="rfvHinh" runat="server" ControlToValidate="FHinh" 
                ErrorMessage="Vui lòng chọn ảnh bìa" ForeColor="Red" Display="Dynamic">*</asp:RequiredFieldValidator>
        </div>
        ...
        <div class="form-group text-center">
            ...
            <asp:Label ID="lblThongBao" runat="server" Text="" CssClass="d-block mt-2 font-weight-bold"></asp:Label>
        </div>
